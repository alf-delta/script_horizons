...
// ============================================================
// Drop this into horizons-getaways-script.jsx alongside
// the existing `modules` array. See integration guide below.
// ============================================================

export const birthdayModules = [
...

  {
    ...
    script:
      "Hi, is this [Name]? Hey [Name] — this is [your name] calling from Horizons Getaways. You stayed with us at our Florida location a while back, and I just wanted to reach out personally — we just opened a brand-new location and I thought of you.",
    notes: [
...

  {
    ...
    script:
      "Hi [Name]! This is [your name] from Horizons Getaways. You stayed with us at our Florida location — and I'm calling with some exciting news. We just opened a brand-new location in South Carolina, and I wanted you to be one of the first to hear about it.",
    notes: [
...

  {
    ...
    script:
      "Hi [Name], this is [your name] from Horizons Getaways — you stayed with us in Florida. I actually noticed your birthday is coming up this spring, and I had to call — we just opened a gorgeous new location in South Carolina that would be absolutely perfect for it.",
    notes: [
...

  {
    ...
    script:
      "So we just opened Horizons Sand Hills in South Carolina — it's a glamping retreat with private cottages, open-air spaces, and beautiful nature all around. Really different vibe from Florida, but that same Horizons feel you already know. And with your birthday coming up in [April / May] — I just thought, what a way to celebrate. Imagine waking up in your own private cottage out in nature on your birthday morning.",
    notes: [
...

  {
    ...
    script:
      "Sure! Sand Hills is our newest property — it's in South Carolina, set in nature with private cottages you can book for a night or a weekend. You get your own space, there are outdoor activities on site, and it has that same retreat feel as Florida but in a completely different landscape. It's opening in April, so your birthday timing is actually perfect.",
    notes: [
...

  {
    ...
    script:
      "So [Name] — should I go ahead and check what's available around your birthday? I can tell you exactly what's open and what the rates look like. Takes two minutes. And if you want to hold a date, we can do that right now.",
    notes: [
...

  {
    ...
    script:
      "Perfect! So I'm looking at [dates] — we have [availability]. The rate for that would be [price]. To hold that date I'd just need your name and email — we can handle the rest from there. And happy early birthday, [Name] — this is going to be a great one.",
    notes: [
...

  {
    ...
    script:
      "No problem at all, [Name]. When would be a better time to reach you — would [day] work, maybe around [time]? I'll send you our website in the meantime so you can take a look: gohorizons.us.",
    notes: [
...

  {
    ...
    script:
      "Absolutely, I'll keep it brief — we're Horizons Getaways, you stayed with us in Florida. We just opened a new glamping location in South Carolina, and your birthday is coming up in [April/May] — I thought it might be a perfect fit. Can I send you a quick link and follow up next week?",
    notes: [
...

  {
    ...
    script:
      "No worries at all, [Name] — I completely understand. If you ever want to check out the new location, our website is gohorizons.us. It's worth a look when you have a moment. Hope you have a wonderful birthday this spring!",
    notes: [
...

  {
    ...
    script:
      "Totally fair question. Rates depend on the dates and cottage type — let me pull up what's available around your birthday so I can give you the exact numbers. What dates were you thinking? That way I can give you something real, not a rough guess.",
    notes: [
...

  {
    ...
    script:
      "Oh that's great — happy early birthday! If anything changes or you're looking for a getaway later this year, keep us in mind. Sand Hills is going to be stunning in the summer too. I'll send you the link — gohorizons.us — just to have it.",
    notes: [
...

  {
    ...
    script:
      "Totally understand — no pressure at all. The one thing I'll mention is that April and May tend to book up pretty fast since it's opening season for us. Want me to just check what's still open around your birthday so you have the info? You don't have to decide anything right now.",
    notes: [
...

  {
    ...
    script:
      "Completely understood, [Name]. No pressure at all — I just wanted to make sure you knew about it. Our website is gohorizons.us if you ever feel like checking it out. Hope you have an amazing birthday this spring — take care!",
    notes: [
...
// ============================================================
// COLOR PALETTE — Birthday Mode
// Add to your stageColors object in the main component:
// ============================================================
//
// const birthdayStageColors = {
//   "Opening":   "#7C5C8A",   // warm purple
//   "Pitch":     "#5A7B8F",   // slate blue (reuse from B2B)
//   "Close":     "#4A7C59",   // green (reuse from B2B)
//   "Objection": "#C4553A",   // brick (reuse from B2B)
//   "Info":      "#6B7280",   // gray (reuse from B2B)
// };
